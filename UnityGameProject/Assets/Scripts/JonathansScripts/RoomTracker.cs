...
public class RoomTracker : MonoBehaviour
{
	...
	{
		if (collision.gameObject.transform.parent.transform.parent.name.Contains("=") || collision.gameObject.transform.parent.transform.parent.name.Contains("^") || collision.gameObject.transform.parent.transform.parent.name.Contains("*"))
		{
		...
		{
			switch (collision.gameObject.transform.parent.transform.parent.transform.parent.name)
			{
				// Ground Floor Rooms
				case string a when a.Contains("=Entra"):
					RoomIn = "GrdEnt";
